        ...
        {cart.length > 0 && (
          <div className="px-6 py-4 bg-brown/5 border-b border-brown/10 animate-fade-in">
            <div className="flex justify-between items-center mb-2">
              <span className={`text-[10px] font-bold uppercase tracking-wider ${belowMin ? "text-brown/60" : "text-green"}`}>
            ...
            <div className="h-2 w-full bg-brown/10 rounded-full overflow-hidden">
              <div 
                className={`h-full transition-all duration-500 ease-out ${belowMin ? "bg-orange" : "bg-green"}`}
