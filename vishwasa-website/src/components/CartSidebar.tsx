          ...
          {cart.length === 0 ? (
            ...
            <div className="space-y-4">
              {cart.map((item) => (
                <div
                  key={item.id}
                  className="flex gap-4 bg-white p-3 rounded-xl shadow-sm border border-brown/10"
                >
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <h4 className="font-bold text-brown leading-tight line-clamp-2">
                        {item.name}
                      </h4>
                      <div className="text-sm text-orange font-medium mt-1">
                        {item.price}
                      </div>
                    </div>
                    <div className="flex items-center justify-between mt-3">
                      <div className="flex items-center gap-3 bg-cream px-2 py-1 rounded-lg border border-brown/10">
                        <button
                          ...
                          className="text-brown hover:text-orange"
                        >
                          <Minus size={16} />
                        </button>
                        <span className="font-bold text-brown w-4 text-center">
                          {item.quantity}
                        </span>
                        <button
                          onClick={() =>
        ...
        {cart.length > 0 && (
          <div className="border-t-2 border-brown/10 bg-white p-6 shadow-[0_-10px_20px_rgba(0,0,0,0.05)]">
            <div className="mb-4 space-y-3">
              <label className="font-bold text-brown mb-2 text-sm uppercase tracking-wider block">
